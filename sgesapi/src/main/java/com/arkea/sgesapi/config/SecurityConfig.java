...
import com.arkea.sgesapi.security.JwtAuthFilter;
 ...
 * <p>
 * Endpoints publics : /api/v1/auth/**, /swagger-ui/**, /api-docs/**
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // En dev : autoriser tous les endpoints API sans authentification
                        .requestMatchers("/api/v1/**").permitAll()
                        .requestMatchers("/rested/**").permitAll()
