...
public class PersonnesService {
     ...
     * Retourne null si l'identifiant est null ou inconnu.
     *
    ...
    public String resoudreLibellePersonne(String identifiant) {
        ...
        Map<String, PersonneMinimaleDto> result = personnesDao.getInformationsMinimalesPersonnes(List.of(identifiant));
    ...
    public String[] resoudreEmprunteurCoEmprunteur(String noEmprunteur, String noCoEmprunteur) {
        ...
        Map<String, PersonneMinimaleDto> personnes = personnesDao.getInformationsMinimalesPersonnes(identifiants);
